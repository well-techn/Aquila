...
void Convert_Q_to_degrees(float q0, float q1, float q2, float q3, float* pitch, float* roll, float* yaw)
{
    ...
    *pitch = -asin(a32) * 57.29577951f;  // 180/пи
    *roll = atan2(a31, a33) * 57.29577951f;  
    *yaw = -atan2(a12, a22) * 57.29577951f;
}
...
void Convert_Q_to_degrees_fast(float q0, float q1, float q2, float q3, float* pitch, float* roll, float* yaw)
{
    ...
    *pitch = -asin_approx(a32) * 57.29577951f;  // 180/пи
    *roll = atan2_approx(a31, a33) * 57.29577951f;   
    *yaw = -atan2_approx(a12, a22) * 57.29577951f;
}
