...
printf("8 -> стереть калибровочные коэффициенты в NVS\r\n");
...
//выполняем действия в зависимости от введенной опции  
            switch (data[0]) 
            {
                ...
                case '3':
                    printf("3 - Запускаем тестирование двигателей через 5 секунд, убедитесь в безопасности операции. ESC для прерывания\n");
                    xTaskCreate(engines_test,"engines_test",4096,NULL,1,NULL);    
                    break;
