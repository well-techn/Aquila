...
24	ошибка системы питания (ток или напряжение перед взлетом за пределами допустимых значений)
30  ошибка по обоим IMU в ходе рабочего цикла (входим в emergency mode)
31  прерывание по IMU вернуло неизвестный статус (входим в emergency mode)
32  срабатывание защиты по углу и ускорению (входим в emergency mode)
33  срабатывание таймера зависания основного полетного цикла (входим в emergency mode)
34  срабатывание кнопки аварийной остановки (входим в emergency mode)
*/
